...
title: "Diver Coaching"
description: "Refine your scuba skills in Zurich, Switzerland. Personalized coaching in buoyancy, horizontal trim, advanced propulsion kicks, and gear configurations."
---
...
<section class="section" id="coaching-structure">
  <div class="container">
    ...
    <div class="grid-3" style="margin-top: 3rem;">
      <div class="card" id="coaching-step-1">
      ...
      <div class="card" id="coaching-step-3">
        ...
        <p>Post-dive, we slow down the video footage together frame-by-frame. You'll receive specific adjustments, weight redistribution suggestions, and targeted drills to practice on subsequent dives.</p>
      </div>
    </div>
    
    <div style="margin-top: 4rem; text-align: center;">
      <a href="/contact/" class="btn btn-primary" id="btn-coaching-contact">Book a Coaching Session</a>
    </div>
  </div>
</section>
